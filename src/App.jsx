  ...
  const [posts, setPosts] = useState([
    {
      ...
      liked: false,
      replies: [
        { name: "Jordan", text: "A short walk and breathing helps me.", time: "10m ago" }
      ],
      time: "20m ago"
    },
    {
    ...
    },
    {
      ...
      liked: false,
      replies: [
        { name: "Maya", text: "Greek yogurt, berries, and oats is my favorite.", time: "1h ago" }
      ],
      time: "2h ago"
    }
  ]);
            ...
            return (
              <Card key={`${post.name}-${i}`} className="p-5 rounded-3xl">
                ...
                <div className="mt-3 text-sm text-slate-500">
                  {(post.likes || 0)} encourages • {repliesArray.length} replies
                </div>
